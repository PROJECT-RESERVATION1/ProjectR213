...
const List = () => {
  ...
  useEffect(() => {
    ...
    fetch('your_api_endpoint_here')
      ...
      .then((data) => {
        setSearchResults(data); // Set the fetched data in the state
      })
      .catch((error) => {
      ...
      <div className="listContainer">
        <div className="listWrapper">
          ...
          <SearchItem
            ...
            taxiOption={result.taxiOption}
            subtitle={result.subtitle}
            features={result.features}
            cancelOption={result.cancelOption}
            cancelOptionSubtitle={result.cancelOptionSubtitle}
            rating={result.rating}
            price={result.price}
            taxOption={result.taxOption}
          />
        ))}
          </div>
        </div>
